...
var AnzahlKommastellenVerbrauch = 6;
var AnzahlKommastellenZaehlerstand = 6;
...
var eigeneDatenpunkte = [
    ...
    // [myDevices.Licht.Kueche.Speisekammer.Energie.getId(), 'Licht.Kueche.Speisekammer', 'Wh', 'kWh'],
    // [myDevices.Licht.WC.Energie.getId(), 'WC.Licht', 'Wh', 'kWh'],
    // [myDevices.Licht.Bad.Main.Energie.getId(), 'Bad.Licht.Main', 'Wh', 'kWh'],
    // [myDevices.Licht.Bad.Dusche.Energie.getId(), 'Bad.Licht.Dusche', 'Wh', 'kWh'],
    // [myDevices.Licht.Flur.Nische.Energie.getId(), 'Flur.Licht.Nische', 'Wh', 'kWh'],
    // [myDevices.Licht.Flur.Main.Energie.getId(), 'Flur.Licht.Main', 'Wh', 'kWh'],
    // [myDevices.Licht.Schlafzimmer.Vorne.Energie.getId(), 'Schlafzimmer.Licht.Vorne', 'Wh', 'kWh'],
    // [myDevices.Licht.Schlafzimmer.Hinten.Energie.getId(), 'Schlafzimmer.Licht.Hinten', 'Wh', 'kWh'],
    // [myDevices.Licht.Wohnzimmer.Vorne.Energie.getId(), 'Wohnzimmer.Licht.Vorne', 'Wh', 'kWh'],
    // [myDevices.Licht.Wohnzimmer.Hinten.Energie.getId(), 'Wohnzimmer.Licht.Hinten', 'Wh', 'kWh'],
    // [myDevices.Licht.Esszimmer.Links.Energie.getId(), 'Esszimmer.Licht.Links', 'Wh', 'kWh'],
    // [myDevices.Licht.Esszimmer.Links.Energie.getId(), 'Esszimmer.Licht.Rechts', 'Wh', 'kWh'],

    // [myDevices.Sensoren.Strom.Wohnung.Energie.getId(), 'Stromzaehler', 'Wh', 'kWh'],

    // [myDevices.Schalter.Wohnzimmer.Zentrale.Energie.getId(), 'Wohnzimmer.TheBrain', 'Wh', 'kWh'],
    // [myDevices.Schalter.Wohnzimmer.Fernseher.Energie.getId(), 'Wohnzimmer.TV', 'Wh', 'kWh'],
    // [myDevices.Schalter.Wohnzimmer.Media.Energie.getId(), 'Wohnzimmer.Media', 'Wh', 'kWh'],

    // [myDevices.Schalter.Flur.Server.Energie.getId(), 'Flur.IoBroker', 'Wh', 'kWh'],

    // [myDevices.Schalter.Keller.Waschmaschine.Energie.getId(), 'Keller.Waschmaschine', 'Wh', 'kWh'],
    // [myDevices.Schalter.Keller.Trockner.Energie.getId(), 'Keller.Trockner', 'Wh', 'kWh'],


    // [myDevices.Schalter.Kueche.Kuehlschrank.Energie.getId(), 'Schalter.Kueche.Kuehlschrank', 'Wh', 'kWh'],
    // [myDevices.Schalter.Kueche.Spuelmaschine.Energie.getId(), 'Schalter.Kueche.Spuelmaschine', 'Wh', 'kWh'],

    // // neu
    // [myDevices.Licht.Energie.getId(), 'Licht.Summe', 'Wh', 'kWh'],
    // [myDevices.Schalter.Energie.getId(), 'Schalter.Summe', 'Wh', 'kWh'],
